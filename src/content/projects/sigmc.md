---
title: "SIGMC - Sistema de Gestión"
type: "Fullstack & BI"
status: "Completado"
technologies: ["React", "FastAPI", "Python", "Google BigQuery", "Firebase"]
gcp_cost: "$1,050"
gcp_cost_trend: "up"
gcp_cost_change: "52%"
screenshots: [inicio-sigmc.png, carga-de-datos-sigmc.png, graficos-geosort-sigmc.png]
---
...
| Otros ahorros | -$446 |
| **Subtotal** | **$1,050** |
| Variación mes anterior | ↑ 52% |

> Proyecto GCP: `sigmc-5fae5` — ID `519623119758`